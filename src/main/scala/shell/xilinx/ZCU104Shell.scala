...
{
  //Quad-SPI Component connected to FPGA: TODO
  shell { InModuleBody {
...
object ButtonZCU104PinConstraints {
  ...
  //GPIO_PB_SW0, GPIO_PB_SW1, GPIO_PB_SW2, GPIO_PB_SW3
...
object SwitchZCU104PinConstraints {
  ...
  //GPIO_DIP_SW0, GPIO_DIP_SW1, GPIO_DIP_SW2, GPIO_DIP_SW3
  val pins = Seq("E4", "D4", "F5", "F4")
}
  ...
  extends JTAGDebugXilinxPlacedOverlay(name, designInput, shellInput)
{
  shell { InModuleBody {
    val pin_locations = Map(
      ...
      //                PMOD0_2    , PMOD0_5    , PMOD0_4    , PMOD0_0    , PMOD0_1
      "PMOD_J55" -> Seq("G7"       , "H6"       , "G6"       , "G8"       , "H8"),
      // PMOD vertical male, pg 62 ZCU104 User Guide
      //                PMOD1_2    , PMOD1_5    , PMOD1_4    , PMOD1_0    , PMOD1_1
      "PMOD_J87" -> Seq("K8"       , "M10"      , "L10"      , "J9"       , "K9")
    )
